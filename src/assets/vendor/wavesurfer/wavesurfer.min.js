            ...
            (function (_util$Observer) {
              ...
              function Drawer(container, params) {
                ...
                _this = _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(Drawer).call(this),
                );
                /** @private */
          ...
          var MultiCanvas =
            ...
            (function (_Drawer) {
              ...
              function MultiCanvas(container, params) {
                ...
                _this = _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(MultiCanvas).call(this, container, params),
                );
                /**
                 * @type {number}
                 * @private
                  ...
                  value: function drawBars(peaks, channelIndex, start, end) {
                    ...
                    return this.prepareDraw(
                      ...
                      function (_ref) {
                        ...
                        var bar =
                          _this3.params.barWidth * _this3.params.pixelRatio;
                        var gap =
                          _this3.params.barGap === null
                            ? Math.max(_this3.params.pixelRatio, ~~(bar / 2))
                            : Math.max(
                                _this3.params.pixelRatio,
                                _this3.params.barGap * _this3.params.pixelRatio,
                              );
                        var step = bar + gap;
                  ...
                  value: function drawWave(peaks, channelIndex, start, end) {
                    ...
                    return this.prepareDraw(
                      ...
                      function (_ref2) {
                        ...
                        _this4.fillRect(
                          0,
                          halfH + offsetY - _this4.halfPixel,
                          _this4.width,
                          _this4.halfPixel,
                          _this4.barRadius,
                        );
                    ...
                    return util.frame(function () {
                      ...
                      if (peaks[0] instanceof Array) {
                        ...
                        if (_this6.params.splitChannels) {
                          _this6.setHeight(
                            channels.length *
                              _this6.params.height *
                              _this6.params.pixelRatio,
                          );

                          return channels.forEach(function (channelPeaks, i) {
                            return _this6.prepareDraw(
                              channelPeaks,
                              i,
                              start,
                              end,
                      ...
                      var height =
                        _this6.params.height * _this6.params.pixelRatio;
          ...
          var MediaElementWebAudio =
            ...
            (function (_MediaElement) {
              ...
              function MediaElementWebAudio(params) {
                ...
                _this = _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(MediaElementWebAudio).call(this, params),
                );
                /** @private */
          ...
          var MediaElement =
            ...
            (function (_WebAudio) {
              ...
              function MediaElement(params) {
                ...
                _this = _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(MediaElement).call(this, params),
                );
                /** @private */
  ...
  \***************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _ajax = _interopRequireDefault(
            __webpack_require__(/*! ./ajax */ './src/util/ajax.js'),
          );
          ...
          var _extend = _interopRequireDefault(
            __webpack_require__(/*! ./extend */ './src/util/extend.js'),
          );
          ...
          var WaveSurfer =
            ...
            (function (_util$Observer) {
              ...
              function WaveSurfer(params) {
                ...
                _this = _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(WaveSurfer).call(this),
                );
                /**
          ...
          var WebAudio =
            ...
            (function (_util$Observer) {
              ...
              function WebAudio(params) {
                ...
                _this = _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(WebAudio).call(this),
                );
                /** @private */
